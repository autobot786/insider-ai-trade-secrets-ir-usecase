...
│
├── 🛡️ detections/                       # Detection rules & queries
...
### 1️⃣ **Notebooks** (Analysis & Detection)
...
### 2️⃣ **Detections** (Sigma + SIEM Queries)
...
### 4️⃣ **Tabletop Exercise (TTX) Materials**
...
Made with ❤️ for security professionals training to defend against insider threats
